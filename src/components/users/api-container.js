...
class UsersApiComponent extends React.Component {
    ...
    render() {
        ...
        return <Users totalUsersCount={totalUsersCount} pageSize={pageSize} currentPage={currentPage} users={users}
                      onPageChange={this.onPageChange} follow={follow} unffollow={unfollow}/>
    };
}
